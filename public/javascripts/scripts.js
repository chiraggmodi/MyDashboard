...
// Scroll animation   ----------------------------------------
	...
	$(document.body).on('appear', '#personal div.anim', function() {
		$(this).each(function(){ 			
			setTimeout (function (){				
				$('#personal div.anim').animate({opacity:'1', top:'0'},{queue:true,duration:1200});
			}, 600 ); 
		});
	});		
...
// google map styles and functions  --------
	...
	var Chirag = new google.maps.LatLng(23.0467116,72.5954644);	
	function initialize() {	
	   var styles = [
    {
		featureType: 'water',
	...
	var companyPos = new google.maps.LatLng(23.0467116,72.5954644);
